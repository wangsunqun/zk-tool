...
public class JZVNode extends JPanel {
    ...
    private JPanel getStatsPanel() {
        if (statsPanel == null) {
            ...
            statsPanel.setBorder(BorderFactory.createTitledBorder("Stat"));
    ...
    private JPanel getNewChildPanel() {
        if (newChildPanel == null) {
            ...
            newChildPanel.setBorder(BorderFactory.createTitledBorder("New child"));
            newChildPanel.add(
                    new JLabel("Name :"),
    ...
    private Action getAddChildAction() {
        if (addChildAction == null) {
            String actionCommand = "Add child";
            String actionKey = "add.child";
    ...
    private Action getUpdateAction() {
        if (updateAction == null) {
            String actionCommand = "Update";
            String actionKey = "update.node";
            updateAction = new AbstractAction(actionCommand) {
                ...
                private boolean checkAction() {
                    ...
                    // No parent
                    if (nodes == null || nodes.length != 1) {
                        JOptionPane.showMessageDialog(JZVNode.this, "updateWithoutParent",
                                "Error",
                                JOptionPane.ERROR_MESSAGE);
                        return false;
                    }
        ...
        if (this.deleteAction == null) {
            ...
            this.deleteAction = new AbstractAction(actionCommand) {
                ...
                private boolean checkAction() {
                    // No node selected
                    if (nodes == null) {
                        JOptionPane.showMessageDialog(JZVNode.this, "Cannotr update node without selection",
                                "Error",
                                JOptionPane.ERROR_MESSAGE);
                        return false;
                    }
